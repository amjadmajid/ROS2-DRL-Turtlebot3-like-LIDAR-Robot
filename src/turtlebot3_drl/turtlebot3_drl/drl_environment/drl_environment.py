...
class DRLEnvironment(Node):
    def __init__(self, real_robot, is_training):
        ...
        ************************************************************"""
        ...
        # Initialise servers
        self.step_com_server = self.create_service(DrlStep, 'step_com', self.step_com_callback)
    ...
    *******************************************************************************"""
    ...
    def step_com_callback(self, request, response):
...
def main(args=sys.argv[1:]):
    ...
    drl_environment = DRLEnvironment(args[0], args[1])
