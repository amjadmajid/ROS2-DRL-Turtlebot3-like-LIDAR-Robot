...
CUTOFF_EPISODE_COUNT = 500      # Delete models with less than this amount of episode
...
def main():
    ...
    for dir in dirs:
        ...
        if len(logfile) != 1:
            print(f"ERROR: found less or more than 1 logfile for: {dir}")
    ...
    print(f"skipped dirs len: {len(skipped)}")
